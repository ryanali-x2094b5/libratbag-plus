#!/usr/bin/env python3
"""libbag-plus GUI — visual updater for libbag."""
...
class GUI:
 def __init__(self):
 self.root = tk.Tk()
 self.root.title("libbag-plus")
 self.root.geometry("500x400")
 self.root.resizable(False, False)

 # Header
 ttk.Label(self.root, text="libbag-plus", font=("Arial", 16, "bold")).pack(pady=10)
 ttk.Label(self.root, text="Libbag Configuion Tool").pack()
